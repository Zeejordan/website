                            ...
                            <div className="row g-4">
                                <div className="col-md-6 col-lg-4">
                                    <div className="national-item">
                                        <img src="assets/img/img/explore-tour-1.jpg" className="img-fluid w-100 rounded" alt="Image"/>
                                ...
                                <div className="col-md-6 col-lg-4">
                                    <div className="national-item">
                                        <img src="assets/img/img/explore-tour-2.jpg" className="img-fluid w-100 rounded" alt="Image"/>
                                        <div className="national-content">
                                            <div className="national-info">
                                ...
                                <div className="col-md-6 col-lg-4">
                                    <div className="national-item">
                                        <img src="assets/img/img/explore-tour-3.jpg" className="img-fluid w-100 rounded" alt="Image"/>
                                        <div className="national-content">
                                            <div className="national-info">
                                ...
                                <div className="col-md-6 col-lg-4">
                                    <div className="national-item">
                                        <img src="assets/img/img/explore-tour-4.jpg" className="img-fluid w-100 rounded" alt="Image"/>
                                        <div className="national-content">
                                            <div className="national-info">
                                ...
                                <div className="col-md-6 col-lg-4">
                                    <div className="national-item">
                                        <img src="assets/img/img/explore-tour-5.jpg" className="img-fluid w-100 rounded" alt="Image"/>
                                        <div className="national-content">
                                            <div className="national-info">
                                ...
                                <div className="col-md-6 col-lg-4">
                                    <div className="national-item">
                                        <img src="assets/img/img/explore-tour-6.jpg" className="img-fluid w-100 rounded" alt="Image"/>
                                        <div className="national-content">
                                            <div className="national-info">
